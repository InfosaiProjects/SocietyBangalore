...
<body onload="getAllBranchMaster();fetchMaxGLGroupNo(); "
								...
								<div class="box-body">
									<div class="col-md-6">
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input name="name" type="text" id="name"
													...
													autocomplete="off" /> <span id="branchNameMsg"
													style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Enter
													Bank Name</span>
											</div>
										</div>
										...
										<div class="checkbox-container">
											<label for="allowInterBranchCheckbox">Allow Inter
												Branch Transaction</label> <input
												value="Allow Inter Branch Transaction" type="checkbox"
												id="allowInterBranchCheckbox"
												name="allowInterBranchCheckbox" style="margin-left: 5px;">
										</div>
										<div class="checkbox-container">
											<label for="fundTransferCheckbox">Is For Fund
												Transfer</label> <input value="Is For Fund Transfer" type="checkbox"
												id="fundTransferCheckbox" name="fundTransferCheckbox"
									...
									<div class="col-md-6">
										...
										<div class="form-group row">
											<label class="col-sm-4 control-label">Account Open
										...
										<div class="form-group row">
											...
											<div class="col-sm-8">
												<input name="balance" type="text" id="balance"
													readonly="readonly" class="form-control" placeholder="0.00"
													autocomplete="off" /> <span id="ifscCodeMsg"
													style="color: Red; font-size: X-Small; font-weight: bold; display: none;">Enter
													Balance</span>
											</div>
	...
	function validateIFSCCode(ifscCode) {
        ...
        // Check if the IFSC code matches the expected format
        ...
        return true; // Valid IFSC code
                ...
                $("#savebtn").click(function () {
                   ...
                   var allowInterBranchCheckbox = $("#allowInterBranchCheckbox").prop("checked");
                   var fundTransferCheckbox = $("#fundTransferCheckbox").prop("checked");
                 
                    // Check if any field is empty
                    if (branchCode === "" || name === "" || openingDate === "" || address === "" || pin === ""
                    || state === "" || contactPerson === "" || contactNo === "" || bankAccoununtNo === "" || branch === ""
                    || accountType === "" || status === "" || (fundTransferCheckbox  && ifscCode === "")) {

                          alert("Some  Fields are required.");
                          return;
                    }
                    
                 	// Validate IFSC code if "Is For Fund Transfer" checkbox is checked
                    if (fundTransferCheckbox && !validateIFSCCode(ifscCode)) {
                    ...
                    var data = {
                        ...
                        "selectTransactionCheckbox": (allowInterBranchCheckbox ? 'allowInterBranchCheckbox' : '') + (fundTransferCheckbox ? 'fundTransferCheckbox' : ''),
                    };
